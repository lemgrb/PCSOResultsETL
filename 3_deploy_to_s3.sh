...
aws s3 rm $S3URI/_next --recursive
aws s3 rm $S3URI/resulthistory --recursive
aws s3 rm $S3URI/sitemap.xml --recursive
aws s3 rm $S3URI/index.html --recursive
echo "Sync to s3"
aws s3 sync s3 $S3URI
